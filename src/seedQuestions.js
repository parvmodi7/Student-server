...
const questions = [
  ...
  { subject: 'Physics', difficulty: 'Easy', question: 'What is Newton\'s second law of motion?', options: [{ text: 'F = ma', isCorrect: true }, { text: 'F = mv', isCorrect: false }, { text: 'E = mc²', isCorrect: false }, { text: 'P = mv', isCorrect: false }], hint: 'Force equals...', explanation: 'Newton\'s Second Law: F = ma (Force = mass × acceleration). It describes how the velocity of an object changes when subjected to an external force.' },
  { subject: 'Physics', difficulty: 'Easy', question: 'What is the SI unit of electric current?', options: [{ text: 'Volt', isCorrect: false }, { text: 'Watt', isCorrect: false }, { text: 'Ampere', isCorrect: true }, { text: 'Ohm', isCorrect: false }], hint: 'Named after André-Marie...', explanation: 'The Ampere (A) is the SI unit of electric current. It measures the rate of flow of electric charge.' },
  { subject: 'Physics', difficulty: 'Easy', question: 'What is the speed of light in vacuum?', options: [{ text: '3 × 10⁶ m/s', isCorrect: false }, { text: '3 × 10⁸ m/s', isCorrect: true }, { text: '3 × 10¹⁰ m/s', isCorrect: false }, { text: '3 × 10⁴ m/s', isCorrect: false }], hint: 'It is approximately 300 million m/s.', explanation: 'The speed of light c ≈ 3 × 10⁸ m/s (299,792,458 m/s exactly). It is the universal speed limit in physics.' },
  { subject: 'Physics', difficulty: 'Medium', question: 'What is the formula for kinetic energy?', options: [{ text: 'KE = mgh', isCorrect: false }, { text: 'KE = ½mv²', isCorrect: true }, { text: 'KE = Fd', isCorrect: false }, { text: 'KE = mv', isCorrect: false }], hint: 'It depends on mass and velocity squared.', explanation: 'Kinetic energy KE = ½mv² where m is mass and v is velocity. The energy increases with the square of velocity.' },
  { subject: 'Physics', difficulty: 'Medium', question: 'According to Ohm\'s law, V = ?', options: [{ text: 'I/R', isCorrect: false }, { text: 'IR', isCorrect: true }, { text: 'R/I', isCorrect: false }, { text: 'I²R', isCorrect: false }], hint: 'Voltage equals current times...', explanation: 'Ohm\'s Law: V = IR (Voltage = Current × Resistance). It describes the linear relationship between voltage, current, and resistance in a conductor.' },
  { subject: 'Physics', difficulty: 'Medium', question: 'What is the wavelength of a wave with frequency 500 Hz and speed 340 m/s?', options: [{ text: '0.68 m', isCorrect: true }, { text: '1.47 m', isCorrect: false }, { text: '170000 m', isCorrect: false }, { text: '0.34 m', isCorrect: false }], hint: 'λ = v/f', explanation: 'Using λ = v/f = 340/500 = 0.68 m. The wavelength is the speed divided by the frequency.' },
  { subject: 'Physics', difficulty: 'Medium', question: 'What happens to the period of a pendulum if its length is quadrupled?', options: [{ text: 'Doubles', isCorrect: true }, { text: 'Quadruples', isCorrect: false }, { text: 'Halves', isCorrect: false }, { text: 'Stays same', isCorrect: false }], hint: 'T = 2π√(L/g)', explanation: 'T = 2π√(L/g). If L → 4L, then T → 2π√(4L/g) = 2·2π√(L/g) = 2T. The period doubles.' },
  { subject: 'Physics', difficulty: 'Hard', question: 'What is the de Broglie wavelength formula?', options: [{ text: 'λ = h/p', isCorrect: true }, { text: 'λ = h·p', isCorrect: false }, { text: 'λ = p/h', isCorrect: false }, { text: 'λ = h/E', isCorrect: false }], hint: 'It relates wavelength to momentum via Planck\'s constant.', explanation: 'de Broglie wavelength λ = h/p = h/(mv), where h is Planck\'s constant and p is momentum. It shows that all matter has wave-like properties.' },
  { subject: 'Physics', difficulty: 'Hard', question: 'In special relativity, what is the Lorentz factor γ?', options: [{ text: '1/√(1 - v²/c²)', isCorrect: true }, { text: '√(1 - v²/c²)', isCorrect: false }, { text: 'v/c', isCorrect: false }, { text: 'mc²', isCorrect: false }], hint: 'It approaches infinity as v approaches c.', explanation: 'The Lorentz factor γ = 1/√(1-v²/c²). It describes time dilation and length contraction. As v → c, γ → ∞.' },
  { subject: 'Physics', difficulty: 'Hard', question: 'What is the Heisenberg Uncertainty Principle?', options: [{ text: 'Δx·Δp ≥ ℏ/2', isCorrect: true }, { text: 'Δx·Δp = 0', isCorrect: false }, { text: 'ΔE·Δt = ℏ', isCorrect: false }, { text: 'Δx·Δv ≥ c', isCorrect: false }], hint: 'Position and momentum cannot both be precisely known.', explanation: 'Heisenberg\'s Uncertainty Principle: Δx·Δp ≥ ℏ/2. You cannot simultaneously know both the exact position and momentum of a particle.' },
];
